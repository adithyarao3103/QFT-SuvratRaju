...
\begin{document}
    ...
    \textcolor{red}{
        Notice that since the in-states enter the calculations as kets and the out-states enter the calculation as bras, the action of \(\psi\) and \(\psi^\dagger\) on the in -tates is not the same as their actions on the out-states. That is, if \(\psi\) acts on an in-state it creates an \(N\), while if it acts on an out-state it creates an \(\bar N\), and vice versa for \(\psi^\dagger\). Therefore, an in-directed line with momentum arrow also in-directed will be an incoming \(N\), an in-directed line with momentum arrow out-directed will be an outgoing \(\bar N\), and vice versa for the out-directed line.\vspace{7pt}\\
        One can understand this as following — the arrows on the nucleon lines always track ``Nucleon-number flow'' rather than ``particle vs. antiparticle''. In other words, an incoming \(\psi\) is equivalent to an outgoing \(\psi^\dagger\) and vice versa, where the incoming and outgoing are determined by the momenta arrows. Therefore in the very above vertex, if the momentum \(\textbf{k}_1\) would be the other way, then we would read off both the solid lines as \(N\), while if the momentum \(\textbf{k}_2\) were the other way, then both the solid lines would be \(\bar{N}\)s.\\
    }
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \fill (a) circle (2pt);
            \fill (b) circle (2pt);
            \node at (5.5,0) {\(= \mathcal{M}(\braket{0|T(\phi(x)\phi(y))|0}) = \displaystyle \frac{i}{k^2 - m^2 + i\epsilon}\)};
        \end{tikzpicture}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \fill (a) circle (2pt);
            \fill (b) circle (2pt);
            \node at (5.5,0) {\(= \mathcal{M}(\braket{0|T(\psi^\dagger(x)\psi(y))|0}) = \displaystyle \frac{i}{k^2 - M^2 + i\epsilon}\)};
        \end{tikzpicture}
    \end{figure}
    ...
    \begin{equation*}
        \int \frac{d^k}{(2\pi)^4}(-ig)(2\pi)^4\delta^4(k_1 - k - k_3)\times(-ig)(2\pi)^4\delta^4(k_2 + k - k_4)\times \frac{i}{k^2 - m^2 + i\epsilon} 
    \end{equation*}
    which is equal to 
    \begin{equation*}
        -ig^2 (2\pi)^4\delta^4(k_1 +k_2 - k_3 - k_4) \frac{1}{(k_1 - k_3)^2 + m^2 + i\epsilon}
    \end{equation*}
    ...
    \begin{equation*}
        \int \frac{d^k}{(2\pi)^4}(-ig)(2\pi)^4\delta^4(k_1 - k - k_4)\times(-ig)(2\pi)^4\delta^4(k_2 + k - k_3)\times \frac{i}{k^2 - m^2 + i\epsilon} 
    \end{equation*}
    which is equal to 
    \begin{equation*}
        -ig^2 (2\pi)^4\delta^4(k_1 +k_2 - k_3 - k_4) \frac{1}{(k_1 - k_4)^2 + m^2 + i\epsilon}
    \end{equation*}
    And therefore, the amplitude, as before is 
    \begin{equation*}
        -ig^2 (2\pi)^4\delta^4(k_1 +k_2 - k_3 - k_4) \left( \frac{1}{(k_1 - k_3)^2 + m^2 + i\epsilon} + \frac{1}{(k_1 - k_4)^2 + m^2 + i\epsilon} \right)
    \end{equation*}
    ...
    \begin{equation*}
        \int \frac{d^k}{(2\pi)^4}(-ig)(2\pi)^4\delta^4(k_1 + k_2 - k)\times(-ig)(2\pi)^4\delta^4(k_3 + k_4 - k)\times \frac{i}{k^2 - m^2 + i\epsilon} 
    \end{equation*}
    which evaluates to 
    \begin{equation*}
        -ig^2(2\pi)^4\delta^4(k_1 + k_2 - k_3 - k_4)\frac{1}{(k_1 + k_2)^2 - m^2 + i\epsilon} 
    \end{equation*}
    ...
    \begin{equation*}
        -ig^2(2\pi)^4\delta^4(k_1 + k_2 - k_3 - k_4) \left(  \frac{1}{(k_1 + k_2)^2 - m^2 + i\epsilon} +    \frac{1}{(k_1 
    - k_3)^2 - m^2 + i\epsilon}    \right)
    \end{equation*}
