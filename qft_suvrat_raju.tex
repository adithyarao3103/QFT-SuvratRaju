...
and so on (note that there are more disconnected diagrams, but we are not listing all of them. This discussion and the conclusion will still remain valid under the presence of the other disconnected diagrams too).\\
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.5, transform shape]
        ...
        \begin{scope}[xshift=-12cm]
            ...
            \end{feynman}
        \end{scope}
        \node at (10.7,0) {\Huge $ + ~\cdots = \sum \text{connected pieces}$};
    \end{tikzpicture}
\end{figure}
and 
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.5, transform shape]
        ...
        \begin{scope}[xshift=13cm]
            \begin{feynman}
                ...
                \vertex[above = of e] (f);
                \vertex[below = of e] (g);
                \vertex[right = of e] (e1);
                \vertex[right = of e1] (h);
                \vertex[above = of h] (i);
                \vertex[below = of h] (j);
                \diagram*{
                    (b) --[scalar, half left] (c) --[scalar, half left] (b) --[scalar, half left] (d) --[scalar, half left] (b);
                    (e) --[scalar, half left] (f) --[scalar, half left] (e) --[scalar, half left] (g) --[scalar, half left] (e);
                    (h) --[scalar, half left] (i) --[scalar, half left] (h) --[scalar, half left] (j) --[scalar, half left] (h);
                };
                \draw[fill=black] (b) circle(0.7mm);
                \draw[fill=black] (e) circle(0.7mm);
                \draw[fill=black] (h) circle(0.7mm);
            \end{feynman}
        \end{scope}
        \node at (27,0) {\Huge $ + ~\cdots = \sum \text{disconnected pieces}$};
    \end{tikzpicture}
\end{figure}
